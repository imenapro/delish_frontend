...
export function QuickActions() {
  ...
  const hasRole = (roleNames: string[]) => {
    return roles.some(r => roleNames.includes(r.role.toLowerCase()));
  };
  ...
  const actions = [
    {
      label: 'New Order',
      icon: ShoppingCart,
      onClick: () => navigate(getTenantRoute('/pos')),
    ...
    },
    {
      label: 'Add Product',
      icon: Plus,
      onClick: () => navigate(getTenantRoute('/products')),
    ...
    },
    {
      label: "Today's Sales",
      icon: TrendingUp,
      onClick: () => navigate(getTenantRoute('/reports')),
    ...
    },
    {
      label: 'View Orders',
      icon: FileText,
      onClick: () => navigate(getTenantRoute('/orders')),
    ...
    },
    {
      label: 'Manage Staff',
      icon: Users,
      onClick: () => navigate(getTenantRoute('/staff')),
    ...
    },
    {
      label: 'Inventory',
      icon: Package,
      onClick: () => navigate(getTenantRoute('/inventory')),
    ...
    },
    {
      label: 'Payments',
      icon: CreditCard,
      onClick: () => navigate(getTenantRoute('/finance')),
